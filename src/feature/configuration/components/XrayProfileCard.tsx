    ...
    return (
        <div className="border rounded-xl p-6 bg-mauve-50/50 flex flex-col gap-4 text-left">
            ...
            <div className="flex flex-col gap-2 max-w-sm">
                <FieldLabel text="Profile Name" tooltip="" required={true} />
                <Input 
            ...
            <div className="grid grid-cols-2 gap-6 mt-2">
                <div className="flex flex-col gap-2">
                    <FieldLabel text="X Position (mm)" tooltip="" required={true} />
                    <Input 
                ...
                <div className="flex flex-col gap-2">
                    <FieldLabel text="Z Position (mm)" tooltip="" required={true} />
                    <Input 
                ...
                <div className="flex flex-col gap-2">
                    <FieldLabel text="Initial Angle (º)" tooltip="" required={true} />
                    <Input 
                ...
                <div className="flex flex-col gap-2">
                    <FieldLabel text="Final Angle (º)" tooltip="" required={true} />
                    <Input 
                ...
                <div className="flex flex-col gap-2">
                    <FieldLabel text="Exposure Time (s)" tooltip="" required={true} />
                    <Input 
                ...
                <div className="flex flex-col gap-2">
                    <FieldLabel text="Attenuation (mm)" tooltip="" required={true} />
                    <Input 
                ...
                <div className="flex flex-col gap-2">
                    <FieldLabel text="Beam Height (mm)" tooltip="" required={true} />
                    <Input 
                ...
                <div className="flex flex-col gap-2">
                    <FieldLabel text="Beam Width (mm)" tooltip="" required={true} />
                    <Input 
